...
PRIVATE_KEY=0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80 \
  ...
  --no-verify
```
`--legacy` is needed for some Anvil configurations (pre-EIP-1559). `--no-verify` prevents Etherscan lookups that fail in restricted or offline environments. Omit both flags when deploying to live networks.
